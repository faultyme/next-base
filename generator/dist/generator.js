...
import { mergePackageJson, readJsonFile, writeJsonFile, } from "./package-json.js";
import { updateProjectReadme } from "./project-readme.js";
import { appendDatabaseReadme } from "./database-readme.js";
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
export function generateProject(projectName, includeDatabase) {
    ...
    if (includeDatabase) {
        ...
        const databaseAdditions = readJsonFile(databaseAdditionsPath);
